...
namespace StaticCode_Analize
{
    ...
    public class StaticCode_AnalizeAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static void FindWrongControllerName(SymbolAnalysisContext context)
        {
            ...
            var controller = context.Compilation.GetTypeByMetadataName("System.Web.Mvc.ControllerBase,System.Web.Mvc");
            //var controller = context.Compilation.GetTypeByMetadataName("System.Collections.ArrayList");
            

            var baseTypes = GetBaseClasses(namedTypeSymbol, context.Compilation.ObjectType);

            // Find just those named type symbols with names containing "Controller".
